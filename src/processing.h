...
public:
    ...
    static std::vector<std::vector<Point2i> > getConvexHullMat(Mat img);
    static int convexityDefects(std::vector<Point>& contour, std::vector<int>& hull, std::vector<Point>& convexDefects);
};
